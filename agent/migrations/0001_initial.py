# Generated by Django 4.2.5 on 2023-09-05 18:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mailing_clients', models.ManyToManyField(blank=True, null=True, to='agent.client', verbose_name='подписчики')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_client', models.ManyToManyField(to='agent.client', verbose_name='подписчик')),
                ('log_mailing', models.ManyToManyField(to='agent.mailing', verbose_name='рассылка')),
            ],
            options={
                'verbose_name': 'лог',
